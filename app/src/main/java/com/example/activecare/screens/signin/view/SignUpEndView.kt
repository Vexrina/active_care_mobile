...
import com.example.activecare.components.SignInTextField
import com.example.activecare.components.TextComponent
import com.example.activecare.components.TextVisuals
...
fun SignUpEndView(
    ...
    Column(
        ...
        TextComponent(
            text = stringResource(id = R.string.sign_up_end_title),
            modifier = Modifier
                .padding(40.dp)
                .width(263.dp),
        ...
        ButtonComponent(
            text = stringResource(id = R.string.sign_up_end_button),
            modifier = Modifier
                .padding(top = 32.dp)
                .height(56.dp)
                .width(327.dp)
